    ...
    return (
        <div className="flex flex-col items-center justify-center min-w-full min-h-screen py-10">
            ...
            <main className="flex flex-col items-center justify-center w-9/12 flex-1 text-center">
                <h1 className="font-bold text-5xl md:text-6xl">Congratulations, {teacher} 🎉</h1>

                <br></br>

                <p className="mt-3 md:text-lg text-base">You have unlocked the Ultimate Gift (the video below)!</p>
